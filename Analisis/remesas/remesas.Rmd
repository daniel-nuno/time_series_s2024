...
Con lo observado en las gráfica y lo comentado anteriormente, las fechas de importancia para esta serie de tiempo son la crisis hipotecaria y la crisis covid.
...
Usando ETS sin especificar ningun parámetro, el modelo se ajusta basado en el el menor error. Esta optimización regresa como resultado un modelo con errores multiplicativos, tendencia aditiva y estacionalidad multiplicativa.
...
Utilizando ARIMA, sin especificar ningun paramtro obtenemos 
...
fit_din %>% gg_tsresiduals()
```
La última regresión dinámica, utlizando las remesas transformadas matemáticamente y las regresoras cómo valores atípicos dan un buen resultado de sigma^2 (0.0049), AIC (-825) y log likelihood (418). Por lo tanto, de los tres modelos revisados para una regresión dinámica nos quedamos esta.
